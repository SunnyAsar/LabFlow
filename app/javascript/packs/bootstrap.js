...
!(function (t, e) {
  ...
  function jt (t) {
    ...
    return i && 'BODY' !== i && 'HTML' !== i
      ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) && 'static' === Nt(n, 'position') ? jt(n) : n
  ...
  function ie (t, n, e) {
    return (
      (void 0 === e
        ...
        t.enabled &&
          Ot(e) &&
          ((n.offsets.popper = Vt(n.offsets.popper)), (n.offsets.reference = Vt(n.offsets.reference)), (n = e(n, t)))
      }),
      n
    )
  }
      ...
      modifiers: {
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            if (
              ((O =
                'bottom' === S ? ('HTML' === b.nodeName ? -b.clientHeight + T.bottom : -w.height + T.bottom) : T.top),
      ...
      return (
          ...
          if (!(this._element.disabled || p(this._element).hasClass(Oe) || p(this._menu).hasClass(Ne))) {
            ...
            p(n).trigger(e),
              e.isDefaultPrevented() ||
                (p(this._menu).toggleClass(Ne), p(n).toggleClass(Ne).trigger(p.Event(Ae.SHOWN, t)))
          }
        }),
        (t.hide = function () {
          if (!this._element.disabled && !p(this._element).hasClass(Oe) && p(this._menu).hasClass(Ne)) {
            ...
            p(n).trigger(e),
              e.isDefaultPrevented() ||
                (p(this._menu).toggleClass(Ne), p(n).toggleClass(Ne).trigger(p.Event(Ae.HIDDEN, t)))
          }
        }),
        (t.dispose = function () {
        ...
        (t._getPlacement = function () {
          ...
          return (
            t.hasClass(ke)
              ...
              : t.hasClass(Le) ? (e = Qe) : t.hasClass(xe) ? (e = Ve) : p(this._menu).hasClass(Pe) && (e = Ke),
            e
          )
        }),
        ...
        (c._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, 'object' == typeof e ? e : null)), p(this).data(Ce, t)), 'string' == typeof e)
            ) {
        ...
        (c._dataApiKeydownHandler = function (t) {
          if (
            (/input|textarea/i.test(t.target.tagName)
              ? !(
                  32 === t.which ||
                  (27 !== t.which && ((40 !== t.which && 38 !== t.which) || p(t.target).closest(Fe).length))
                )
              : Ie.test(t.which)) &&
      ...
      return (
        ...
        (t.toggle = function (t) {
          if (this._isEnabled)
            if (t) {
              ...
              n ||
                ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())), p(t.currentTarget).data(e, n)),
        ...
        (t.setElementContent = function (t, e) {
          'object' != typeof e || (!e.nodeType && !e.jquery)
            ? this.config.html
              ...
              : t.text(e)
            : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text())
        }),
        (t.getTitle = function () {
        ...
        (t._getContainer = function () {
          return !1 === this.config.container
            ? document.body
            : m.isElement(this.config.container) ? p(this.config.container) : p(document).find(this.config.container)
        }),
        ...
        (t._fixTransition = function () {
          ...
          null === t.getAttribute('x-placement') &&
            (p(t).removeClass(Hn), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e))
        }),
        (i._jQueryInterface = function (n) {
          return this.each(function () {
      ...
      return (
        (t.show = function () {
          ...
          if (
            ...
            if (
              (i && p(i).trigger(s), p(this._element).trigger(a), !a.isDefaultPrevented() && !s.isDefaultPrevented())
            ) {
  ...
  var Ui = 'toast',
    ...
    Zi = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          return (
            (t = l({}, $i, p(this._element).data(), 'object' == typeof t && t ? t : {})),
